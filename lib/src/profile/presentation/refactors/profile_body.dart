          ...
          children: [
            Row(
              children: [
                Expanded(
                  child: UserInfoCard(
                    infoTheColour: Colours.physicsTileColour,
                    infoIcon: const Icon(
                ...
                Expanded(
                  child: UserInfoCard(
                    infoTheColour: Colours.languageTileColour,
            ...
            Row(
              children: [
                Expanded(
                  child: UserInfoCard(
                    infoTheColour: Colours.biologyTileColour,
                    infoIcon: const Icon(
                      IconlyLight.user,
                ...
                Expanded(
                  child: UserInfoCard(
                    infoTheColour: Colours.chemistryTileColour,
                    infoIcon: const Icon(
                      IconlyLight.user,
