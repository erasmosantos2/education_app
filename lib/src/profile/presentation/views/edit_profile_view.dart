...
class _EditProfileViewState extends State<EditProfileView> {
  ...
  bool get bioChanged => context.currentUser?.bio != bioController.text.trim();
    ...
    return BlocConsumer<AuthBloc, AuthState>(
      listener: (context, state) {
        if (state is UserUpdated) {
          CoreUtils.showSnackBar(context, 'Perfil atualizado com sucesso');
          context.pop();
            ...
            child: ListView(
              ...
              children: [
                ...
                const Padding(
                  ...
                  child: Text(
                    'Nós recomendamos uma imagem de pelo menos 400x400',
